      ...
      <div className="w-full flex justify-center">
        <form className="container mb-4" action="">
          <input
            type="text"
            placeholder="search..."
            className="w-full p-3 texto-semibold bg-white bg-opacity-25 rounded-md border border-transparent focus:border-purple-500 focus:outline-none transition duration-300 "
          />
